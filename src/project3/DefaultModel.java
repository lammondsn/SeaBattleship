...
public final class DefaultModel extends AbstractModel {
    ...
    public void setPlayer1SquareHit(HashMap<String, Integer> s) {
        ...
        if (player1.getCount() == 0 || player2.getCount() == 0) {
            return;
        }
        ...
        Square square = player1.getPrimary().get(x, y);
            if (square.isHit()) {
            firePropertyChange(DefaultController.SQUARE_ALREADY_HIT, null, null);
            return;
            }
        ...
        if (square instanceof ShipSquare) {
            ...
            if (player1.getCount() == 0) { 
                firePropertyChange(DefaultController.PLAYER2_WINS, null, null);
            }
    ...
    public void setPlayer2SquareHit(HashMap<String, Integer> s) {
        ...
        if (player2.getCount() == 0 || player1.getCount() == 0) {
            return;
        }
        ...
        if (player2.getCount() == 0) {
            firePropertyChange(DefaultController.PLAYER1_WINS, null, null);
        }
