...
public class ViewMainWindow extends JFrame implements AbstractView {
    ...
    public void modelPropertyChange(final PropertyChangeEvent e) {
        ...
        else if (e.getPropertyName().equals(DefaultController.PLAYER1_WINS)) {
            JOptionPane.showMessageDialog(this, "Player 1 Wins!");
        }
        else if (e.getPropertyName().equals(DefaultController.PLAYER2_WINS)) { 
            JOptionPane.showMessageDialog(this, "Player 2 Wins!");
        }
        else if (e.getPropertyName().equals(DefaultController.SQUARE_ALREADY_HIT)) {
            JOptionPane.showMessageDialog(this, "Square has already been hit!");
        }
