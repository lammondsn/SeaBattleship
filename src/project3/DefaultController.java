...
public class DefaultController extends AbstractController
{
    ...
    public static final String SQUARE_ALREADY_HIT = "SquareAlreadyHit";
    public static final String PLAYER1_WINS = "Player1Wins";
    public static final String PLAYER2_WINS = "Player2Wins";
